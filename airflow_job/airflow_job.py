...
with DAG(
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "446791444824-compute@developer.gserviceaccount.com",
                "network_uri": "projects/pyspark-practice-445003/global/networks/default",
                "subnetwork_uri": "projects/pyspark-practice-445003/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="pyspark-practice-445003",
        region="us-central1",
